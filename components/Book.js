  ...
  return (
    ...
    <View style={styles.container}>
      <View>
        ...
        <View style={styles.details}>
          ...
          <Text>Old Student House 9 Street</Text>
        </View>
        <View style={styles.details}>
    ...
    <View style={styles.lastLayer}>
        ...
        <View style={styles.oneLine}>
          <Text style={{color: '#2C3D55', fontWeight: 'bold', fontSize: 16}}>Total: Rp 175.000</Text>
          <View style={styles.button}>
            <Text style={{color: colors.white, fontSize: 15, fontWeight: 'bold'}}>Booking</Text>
          </View>
        </View>
    </View>
