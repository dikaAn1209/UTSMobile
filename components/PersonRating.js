    ...
    <ScrollView style={styles.infoContainer}>
      ...
      <View style={styles.buttonWrapper}>
        <View style={styles.infoButton}>
          <Text style={styles.infoText}>Informasi</Text>
        </View>
        <View style={styles.reviewButton}>
          <Text style={styles.reviewText}>Ulasan</Text>
        </View>
      </View>
      </TouchableOpacity>
      <View style={styles.marginMain}>
        <View style={styles.starWrapper}>
          ...
          <Text style={styles.infoTitle}>Ulasan Terakhir</Text>
          <Text style={styles.infoParagraph}>{"Sangat baik, dia membantu saya dalam memperbaiki PC saya yang mati total."} </Text>
        </View>
        <View style={styles.meterWrapper}>
          <View style={styles.meterRow}>
            <Text style={styles.ratingText}>5 Bintang</Text>
          ...
          <View style={styles.meterRow}>
            <Text style={styles.ratingText}>4 Bintang</Text>
            <Image source={require('../assets/images/rating/Rectangle2.png')} />
            <Image style={styles.greyContainer} source={require('../assets/images/rating/Rectangle.png')} />
          </View>
          <View style={styles.meterRow}>
            <Text style={styles.ratingText}>3 Bintang</Text>
            <Image source={require('../assets/images/rating/Rectangle3.png')} />
            <Image style={styles.greyContainer} source={require('../assets/images/rating/Rectangle.png')} />
          </View>
          <View style={styles.meterRow}>
            <Text style={styles.ratingText}>2 Bintang</Text>
            <Image source={require('../assets/images/rating/Rectangle4.png')} />
            <Image style={styles.greyContainer} source={require('../assets/images/rating/Rectangle.png')} />
          </View>
          <View style={styles.meterRow}>
            <Text style={styles.ratingText}>1 Bintang</Text>
            <Image source={require('../assets/images/rating/Rectangle5.png')} />
            <Image style={styles.greyContainer} source={require('../assets/images/rating/Rectangle.png')} />
          </View>
        </View>
        <View style={styles.commentContainer}>
          <Text style={styles.commentText}>{"Luar biasa, dia mampu memperbaiki laptop saya yang tidak berfungsi karena terserang malware."}</Text>
          <View style={styles.footerComment}>
            <Text style={styles.authorStyle}>Barbara Page</Text>
