  ...
  return (
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.dealContainer}>
        <Text style={{fontFamily: 'Poppins', fontWeight: 'bold' }}>Tawaran Hari Ini</Text>
        <View style={styles.dealWrapper}>
          <Image style={{marginRight: 20}} source={require('../assets/images/main/language1.png')} />
          <View>
            <Text style={{fontFamily: 'Poppins', fontWeight: 'bold', }}>Maintenance Notebook/Laptop</Text>
            <Text>Dusting dan Penggantian Thermalpaste</Text>
            <Text style={{color: '#EF6A62',  fontWeight: 'bold'}}>Rp 55.000</Text>
          </View>
        </View>
      </View>
