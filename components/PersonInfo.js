    ...
    <View>
      ...
      <View style={styles.infoContainer}>
        <View style={styles.headerProfile}>
          ...
          <Text style={styles.address}>Bangli, Bali</Text>
        </View>
        <View style={styles.infoWrapper}>
          <Text style={styles.infoTitle}>Info</Text>
          <Text style={styles.infoParagraph}>{"Tidak ada sistem yang aman"} </Text>
        </View>
        <View style={styles.contWrapper}>
          <Text style={styles.contactText}>Kontak</Text>
          <View style={styles.contactWrapper}>
            <View style={styles.phoneButton}>
              <Image source={require('../assets/images/info/path1.png')} />
              <Text style={styles.phoneText}>080989999</Text>
            </View>
            <View style={styles.websiteButton}>
              <Image source={require('../assets/images/info/website.png')} />
              <Text style={styles.websiteText}>fjd38fj.onion</Text>
            </View>
          </View>
        </View>
      </View>
